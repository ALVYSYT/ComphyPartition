...
for i in range(1000):
    ...
    shape = set()
    for one_obj in pro:
        shape_num = one_obj['material']
        shape.add(one_obj['material'])
        all_attri.add(one_obj['material'])
...
print("The property we partition is Material")
print(tally)
...
for i in range(len(shape_1_fn_a)):
    ...
    shutil.copy(shape_1_fn_a[i], "material1/target_annotation/annotation_" + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".json")
    shutil.copy(shape_1_fn_v[i], "material2/target/video_"  + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".mp4")

for i in range(len(shape_2_fn_a)):

    shutil.copy(shape_2_fn_a[i], "material2/target_annotation/annotation_" + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".json")
    shutil.copy(shape_2_fn_v[i], "material2/target/video_"  + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".mp4")
