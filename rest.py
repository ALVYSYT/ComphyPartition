...
print("The property we partition is restitution")
all_sum = []
shape_1_fn_a = []
shape_1_fn_v = []
shape_2_fn_a = []
...
for i in range(len(shape_2_fn_a)):
    shutil.copy(shape_2_fn_a[i], "rest2/target_annotation/annotation_" + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".json")
    shutil.copy(shape_2_fn_v[i], "rest2/target/video_"  + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".mp4")

for i in range(len(shape_3_fn_a)):
    shutil.copy(shape_3_fn_a[i], "rest3/target_annotation/annotation_" + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".json")
    shutil.copy(shape_3_fn_v[i], "rest3/target/video_"  + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".mp4")
