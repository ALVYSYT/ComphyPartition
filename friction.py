...
print("The property we partition is Friction")
all_sum = []
shape_1_fn_a = []
shape_1_fn_v = []
shape_2_fn_a = []
...
for i in range(10000):
    ...
    for one_obj in pro:
        one_p = one_obj['lateral_friction']
        shape_num = one_p
        sum += shape_num
...
for i in range(len(shape_1_fn_a)):
    shutil.copy(shape_1_fn_a[i], "friction1/target_annotation/annotation_" + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".json")
    shutil.copy(shape_1_fn_v[i], "friction1/target/video_"  + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".mp4")

for i in range(len(shape_2_fn_a)):
    shutil.copy(shape_2_fn_a[i], "friction2/target_annotation/annotation_" + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".json")
    shutil.copy(shape_2_fn_v[i], "friction2/target/video_"  + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".mp4")

for i in range(len(shape_3_fn_a)):
    shutil.copy(shape_3_fn_a[i], "friction3/target_annotation/annotation_" + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".json")
    shutil.copy(shape_3_fn_v[i], "friction3/target/video_"  + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".mp4")
