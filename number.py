...
print("The property we partition is Object Number")
all_sum = []
shape_1_fn_a = []
shape_1_fn_v = []
shape_2_fn_a = []
...
for i in range(len(shape_1_fn_a)):
    shutil.copy(shape_1_fn_a[i], "number1/target_annotation/annotation_" + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".json")
    shutil.copy(shape_1_fn_v[i], "number1/target/video_"  + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".mp4")

for i in range(len(shape_2_fn_a)):
    shutil.copy(shape_2_fn_a[i], "number2/target_annotation/annotation_" + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".json")
    shutil.copy(shape_2_fn_v[i], "number2/target/video_"  + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".mp4")

for i in range(len(shape_3_fn_a)):
    shutil.copy(shape_3_fn_a[i], "number3/target_annotation/annotation_" + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".json")
    shutil.copy(shape_3_fn_v[i], "number3/target/video_"  + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".mp4")
