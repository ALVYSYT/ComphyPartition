...
print("The property we partition is Charge")
print("If the data is in group 1, then there is no charge in the system")
print("If the data is in group 2, then there is charge in the system")
tally = [len(shape_1_fn_a), len(shape_2_fn_a)]
...
for i in range(len(shape_1_fn_a)):
    shutil.copy(shape_1_fn_a[i], "charge0/target_annotation/annotation_" + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".json")
    shutil.copy(shape_1_fn_v[i], "charge0/target/video_"  + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".mp4")

for i in range(len(shape_2_fn_a)):
    shutil.copy(shape_2_fn_a[i], "charge1/target_annotation/annotation_" + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".json")
    shutil.copy(shape_2_fn_v[i], "charge1/target/video_"  + folder_index(i) + '_' + folder_index_next(i) + '/' + convert_num(i) + ".mp4")
